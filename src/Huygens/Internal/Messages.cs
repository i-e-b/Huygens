...
namespace Huygens.Internal
{
    ...
    /// <summary>
    /// Error and directory listing pages simulating IIS 7 pages
    /// </summary>
...
";
        ...
        public static string VersionString = typeof (SocketServer).Assembly.GetName().Version.ToString();

        private static readonly string _dirListingTail =
            @"</PRE>
            <hr width=100% size=1 color=silver>

            <b>Version Information:</b>&nbsp;Huygens Web Server Component " +
            VersionString + @"
...
";
    ...
    <body bgcolor=""white"">
            ...
            <b>Version Information:</b>&nbsp;Huygens Web Server Component {VersionString}
